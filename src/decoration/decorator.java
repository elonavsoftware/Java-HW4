...
/**
 * decorator class, extends JDialog and implements ActionListener, ItemListener
 * @author Mahdi Asali
 *
 */
...
public class decorator extends JDialog implements ActionListener, ItemListener
{
	    ...
	    public decorator(ZooPanel pan)
	    {
			...
			selectPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Select Animal to decorate"), 
			...
			colorPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Choose decoration color"), 
			BorderFactory.createEmptyBorder(5,5,5,5)));
		...
		public void actionPerformed(ActionEvent e)
		{
	    	...
	    	else
	    	{
		    	...
		    	if(list.getSelectedIndex() != 0)
		    	{
		    		...
		    		{
		    			System.out.println("Decorate error! "); an = null;
		    		}
		    	}		
	    	}
		}
} //class decorator extends JDialog implements ActionListener, ItemListener
