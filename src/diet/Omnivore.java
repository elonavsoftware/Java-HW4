...
public class Omnivore implements IDiet
{
	 ...
	 */
	@Override
	public boolean canEat(IEdible food) { return this.canrivore.canEat(food) || this.herbivore.canEat(food); }

	public boolean canEat(EFoodType food_type) { return food_type != EFoodType.NOTFOOD; }
